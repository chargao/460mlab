...
Divider Clk_Db (clk_100MHz, 28'd5000000, clk_db);

Four_Digit_7_seg_Display seven (BCD_Time, clk_100Hz, En_7seg, An0, An1, An2, An3, ca, cb, cc, cd, ce, cf, cg);

//Button_db_sp BtnU (btnU, clk_db, clk_100Hz, btnU_out);
//Button_db_sp BtnL (btnL, clk_db, clk_100Hz, btnL_out);
//Button_db_sp BtnR (btnR, clk_db, clk_100Hz, btnR_out);
//Button_db_sp BtnD (btnD, clk_db, clk_100Hz, btnD_out);
