...
module Button_db_sp (k, clk_db, out);//clk_sp, out);
  ...
  reg da,db,kd;//,sp;   // Three registers total, db and kd synchronize our button to the clock. Sp and comb logic implement
                  // our single pulser.
  initial
    begin
      da <= 0;
