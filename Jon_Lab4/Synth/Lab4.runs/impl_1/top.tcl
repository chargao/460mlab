...
set rc [catch {
  ...
  set_property ip_repo_paths c:/Modeltech_pe_edu_10.4a/examples/460mlab/Jon_Lab4/Synth/Lab4.cache/ip [current_project]
  set_property ip_output_repo c:/Modeltech_pe_edu_10.4a/examples/460mlab/Jon_Lab4/Synth/Lab4.cache/ip [current_project]
  add_files -quiet C:/Modeltech_pe_edu_10.4a/examples/460mlab/Jon_Lab4/Synth/Lab4.runs/synth_1/top.dcp
