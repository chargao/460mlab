...
set rc [catch {
  ...
  set_property ip_repo_paths f:/EE460M/Lab7/Lab7_synth/Lab7_synth.cache/ip [current_project]
  set_property ip_output_repo f:/EE460M/Lab7/Lab7_synth/Lab7_synth.cache/ip [current_project]
  add_files -quiet F:/EE460M/Lab7/Lab7_synth/Lab7_synth.runs/synth_1/Complete_MIPS.dcp
...
set rc [catch {
  ...
  if { [file exists F:/EE460M/Lab7/Lab7_synth/Lab7_synth.runs/synth_1/Complete_MIPS.hwdef] } {
    catch { write_sysdef -hwdef F:/EE460M/Lab7/Lab7_synth/Lab7_synth.runs/synth_1/Complete_MIPS.hwdef -bitfile Complete_MIPS.bit -meminfo Complete_MIPS.mmi -file Complete_MIPS.sysdef }
  }
